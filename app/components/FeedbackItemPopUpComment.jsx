        ...
        comments?.map((comment, index) => (
          <div className="mb-8 ">
            <div className="flex gap-4">
              <Avatar />
              <div>
                {!!editingComment && commentId === comment._id.toString() ? (
                  <textarea
                ...
                <div className="text-sm text-gray-400 mt-2">
                  ...
                  {!!editingComment && commentId === comment._id.toString() && (
                    <>
                      ...
                      <span onClick={handleSaveChangesClick} className="px-2 py-1 shadow-lg hover:cursor-pointer bg-blue-500 text-white rounded-lg">
                        Save Changes
                      </span>
                    </>
                  )}
